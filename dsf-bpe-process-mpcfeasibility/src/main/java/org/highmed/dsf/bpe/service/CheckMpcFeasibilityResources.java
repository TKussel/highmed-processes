...
import static org.highmed.dsf.bpe.ConstantsMpcFeasibility.MIN_COHORT_DEFINITIONS;
import static org.highmed.dsf.bpe.ConstantsMpcFeasibility.MIN_PARTICIPATING_MEDICS;
...
public class CheckMpcFeasibilityResources extends AbstractServiceDelegate
{
	public CheckMpcFeasibilityResources(FhirWebserviceClientProvider clientProvider, TaskHelper taskHelper,
