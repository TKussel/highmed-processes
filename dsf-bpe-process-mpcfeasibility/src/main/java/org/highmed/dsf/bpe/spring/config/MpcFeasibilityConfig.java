...
import org.highmed.dsf.bpe.service.CheckMpcFeasibilityResources;
...
import org.highmed.dsf.bpe.service.DownloadMpcFeasibilityResources;
...
@Configuration
public class MpcFeasibilityConfig
{
	@Autowired
	...
	//
	// process requestMpcFeasibility implementations
	//
	...
	//
	// process executeMpcFeasibility implementations
	//

	@Bean
	public DownloadMpcFeasibilityResources downloadMpcFeasibilityResources()
	{
		return new DownloadMpcFeasibilityResources(fhirClientProvider, taskHelper, readAccessHelper, organizationProvider);
	}

	@Bean
	public CheckMpcFeasibilityResources checkMpcFeasibilityResources()
	{
		return new CheckMpcFeasibilityResources(fhirClientProvider, taskHelper, readAccessHelper);
	}
	...
	//
	// process computeMpcFeasibility implementations
	//
