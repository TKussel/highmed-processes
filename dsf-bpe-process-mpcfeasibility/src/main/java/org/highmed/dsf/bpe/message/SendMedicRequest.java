...
public class SendMedicRequest extends AbstractTaskMessageSend
{
	...
	protected Stream<ParameterComponent> getAdditionalInputParameters(DelegateExecution execution)
	{
		...
		ParameterComponent inputResearchStudyReference = getTaskHelper().createInput(CODESYSTEM_HIGHMED_MPCFEASIBILITY,
		...
		ParameterComponent inputNeedsConsentCheck = getTaskHelper().createInput(CODESYSTEM_HIGHMED_MPCFEASIBILITY,
				CODESYSTEM_HIGHMED_MPCFEASIBILITY_VALUE_NEEDS_CONSENT_CHECK, needsConsentCheck);
