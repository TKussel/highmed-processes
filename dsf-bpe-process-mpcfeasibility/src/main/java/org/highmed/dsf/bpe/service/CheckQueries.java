...
import static org.highmed.dsf.bpe.ConstantsMpcFeasibility.FEASIBILITY_QUERY_PREFIX;
...
public class CheckQueries extends AbstractServiceDelegate implements InitializingBean, JavaDelegate
{
	...
	protected void doExecute(DelegateExecution execution) throws Exception
	{
		...
		cohorts.forEach(group ->
		{
			...
			if (!aqlQuery.startsWith(MPCFEASIBILITY_QUERY_PREFIX))
			{
				String errorMessage = "Initial single medic mpcfeasibility query check failed, wrong format for query of group with id '"
