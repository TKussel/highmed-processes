...
public class RequestMpcFeasibilityFromMedicsViaMedic1ExampleStarter
		extends AbstractRequestMpcFeasibilityFromMedicsViaMedic1ExampleStarter
{
	...
	{
		new RequestMpcFeasibilityFromMedicsViaMedic1ExampleStarter().main(args, MEDIC_1_FHIR_BASE_URL);
	}
}
