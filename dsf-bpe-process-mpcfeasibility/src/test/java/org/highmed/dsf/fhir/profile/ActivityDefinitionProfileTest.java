...
public class ActivityDefinitionProfileTest
{
	...
	@Test
	public void testComputeMpcFeasibilityValid() throws Exception
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-computeMpcFeasibility.xml")))
		{
	...
	@Test
	public void testExecuteMpcFeasibilityValid() throws Exception
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-executeMpcFeasibility.xml")))
		{
			ActivityDefinition ad = validationRule.getFhirContext().newXmlParser()
					.parseResource(ActivityDefinition.class, in);
	...
	@Test
	public void testRequestMpcFeasibilityValid() throws Exception
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-requestMpcFeasibility.xml")))
		{
			ActivityDefinition ad = validationRule.getFhirContext().newXmlParser()
					.parseResource(ActivityDefinition.class, in);
