...
public class ArithmeticSharingTest {
    ...
    public void fivePartiesDec() {
        ...
        BigDecimal secret3 = new BigDecimal(new BigInteger(90, randomGenerator));
    ...
    public void fivePartiesInt() {
        ...
        BigInteger secret3 = new BigInteger(120, randomGenerator);
    ...
    public void homomorphityDec() {
        ...
        ArithmeticSharing as = new ArithmeticSharing(numParties);
        SecureRandom randomGenerator = new SecureRandom();
        BigDecimal secret1 = new BigDecimal(new BigInteger(90, randomGenerator)).add(BigDecimal.valueOf(0.4532679821));
        BigDecimal secret2 = new BigDecimal(new BigInteger(90, randomGenerator)).add(BigDecimal.valueOf(0.4532679821));
        BigDecimal secret3 = new BigDecimal(new BigInteger(90, randomGenerator)).add(BigDecimal.valueOf(0.4532679821));
    ...
    public void homomorphityInt() {
        ...
        ArithmeticSharing as = new ArithmeticSharing(numParties);
        SecureRandom randomGenerator = new SecureRandom();
        BigInteger secret1 = new BigInteger(120, randomGenerator);
        BigInteger secret2 = new BigInteger(120, randomGenerator);
        BigInteger secret3 = new BigInteger(120, randomGenerator);
    ...
    public void lotPartiesInt() {
        ...
        BigInteger secret3 = new BigInteger(90, randomGenerator);
